Alibaba Cloud Application Load Balancer (ALB) Terraform Module

# terraform-alicloud-http-lb

English | [简体中文](https://github.com/alibabacloud-automation/terraform-alicloud-http-lb/blob/main/README-CN.md)

Terraform module which creates an Application Load Balancer (ALB) on Alibaba Cloud with HTTP/HTTPS listeners and backend server groups. This module is designed as a drop-in replacement for the GCP [terraform-google-lb-http](https://github.com/terraform-google-modules/terraform-google-lb-http) module, providing equivalent load balancing functionality on Alibaba Cloud. For more information about ALB, see the [ALB product documentation](https://www.alibabacloud.com/help/en/alb/).

## Usage

Create an HTTP load balancer with a single backend server group:
...
* [Basic Example](https://github.com/alibabacloud-automation/terraform-alicloud-http-lb/tree/main/examples/basic)
* [Advanced Example](https://github.com/alibabacloud-automation/terraform-alicloud-http-lb/tree/main/examples/advanced)
